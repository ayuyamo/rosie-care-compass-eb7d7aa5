    ...
    <div className="min-h-screen">
      ...
      <div ref={contentRef} className={`transition-all duration-1000 ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '0.2s' }}>
        ...
        <Card className="relative bg-white/90 backdrop-blur-md shadow-lg overflow-hidden p-0 mb-6">
          ...
          <div className="relative z-10 p-6 -mt-10 bg-white/90 backdrop-blur-md rounded-t-3xl">
            <div className="text-center mb-6">
              ...
              {/* Edition Tabs */}
              <div className="mb-6">
                <div className="flex flex-wrap justify-center border-b border-gray-200 overflow-hidden">
                  <button
                    onClick={() => setSelectedEdition('paperback')}
                    className={`px-6 py-2 text-base font-medium transition-colors relative ${selectedEdition === 'paperback'
                      ? 'text-[#232323]'
                      : 'text-gray-500'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-6 py-2 text-base font-medium transition-colors relative ${selectedEdition === 'digital'
                      ? 'text-[#232323]'
                      : 'text-gray-500'
                      }`}
                  >
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                >
                  <Button className="relative w-full h-full flex flex-wrap justify-center mx-auto px-2 whitespace-normal bg-gradient-to-r from-[#ff9500] to-[#ff7f00] text-white hover:from-[#ff8800] hover:to-[#ff6600] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 border-0 font-semibold text-base py-3 rounded-xl">
                    <svg
                      className="h-7 w-7 pt-[3px]"
        ...
        <div className="mb-6 rounded-lg">
          ...
          <div className={` overflow-hidden transition-all duration-1000 ${showDetails ? 'opacity-100 translate-y-0 max-h-full' : 'opacity-0 -translate-y-10 max-h-0'}`}>
            <div className="flex flex-col mt-2 p-4 bg-white/70 backdrop-blur-sm border border-gray-200 rounded-lg space-y-3 shadow-sm">
